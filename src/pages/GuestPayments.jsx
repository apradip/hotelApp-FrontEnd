...
import Add from "../components/guestPayment/GuestPaymentAdd";
import Card from "../components/guestPayment/GuestPaymentCard";
...
// openDelete
// close
const GuestPayments = forwardRef(( props, ref ) => {
    ...
    return ( 
        <>
            ...
            <Breadcrumb className="mt-5">
                ...
                <Breadcrumb.Item active>Guest payment</Breadcrumb.Item>
            </Breadcrumb>
            {/* End :: Bread crumb */}
