...
import Add from "../components/roomCategory/RoomCategoryAdd";
import Card from "../components/roomCategory/RoomCategoryCard";
...
// openDelete
// close
const RoomCategories = forwardRef(( props, ref ) => {
                ...
                <div className="container-fluid">   
                    <div className="row">
                        <div className="col-sm-4 m-0">
                            <h1 className="text-dark">Room category</h1>
                        </div>
